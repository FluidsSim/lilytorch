...
are produced by
``lilytorch.farms_examples.sdfs.jellyfish.generate_jellyfish_mesh``
from the same analytical SDF and referenced by
``farms_examples/sdfs/jellyfish/jellyfish.sdf``.
...
This example mirrors ``farms_examples/submarine/gen_configs_drag.py``:
...
Run with::
    ...
    python -m lilytorch.farms_examples.jellyfish.gen_configs_drag
"""
...
class SimConfig(BaseSimConfig):
    ...
    def __init__(self):
        ...
        self.data_folder = os.path.join(
            lilytorch_repo_root, 'farms_examples', 'jellyfish',
        )
