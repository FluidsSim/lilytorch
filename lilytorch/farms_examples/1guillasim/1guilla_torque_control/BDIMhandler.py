...
class BDIMhandler():
    ...
    def fluid_step(self,u,v,p,timestep):
        ...
        # p*=timestep
        # (p_x, p_y) = self.fluid_solver.gradient(p)
        # (u,v)=(uprime-p_x/self.fluid_solver.rho, vprime-p_y/self.fluid_solver.rho)
