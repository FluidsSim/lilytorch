    ...
    def __init__(self):
        ...
        self.animats_pars = [

            {
                ...
                "muscle_config": {
                    'load_controller': 'lilytorch.examples.zebrafish_ki_project.network.WaveController',
                    'method'         : 'implicit',
            ...
            #     "controller_path": "lilytorch.examples.zebrafishsim.pd_controller.PositionController",
            #     "control_pars"   : {
