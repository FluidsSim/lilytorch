"""PD position-control config using ep248 slow model-angle trajectory.

Loads joint-angle trajectories exported from trained network model
``ep248_Cl2_slow_fish13_model_angles.xlsx`` and drives the zebrafish
through PD position control via ``PositionController``.

Usage
-----
    python gen_configs_pd_3d_ep248_slow.py
"""
