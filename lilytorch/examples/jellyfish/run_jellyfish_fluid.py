...
::
    ...
    python -m lilytorch.examples.jellyfish.run_jellyfish_fluid path/to/config.yaml
...
from lilytorch.examples.jellyfish.jellyfish_body import JellyfishBody, JellyfishParams
