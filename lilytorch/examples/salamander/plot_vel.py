...
BL=0.1
# # exp_name = "slamander_anguill"
exp_name = "salamander_paddle"

dir = os.path.join(save_path, exp_name)
...
with h5py.File(file, 'r') as f:
    ...
    plt.tight_layout()
    plt.savefig(os.path.join("figures", f"com_velocities_{exp_name}.png"))
    plt.close()
