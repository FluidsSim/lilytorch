...
_native_streaming_sdf_3d = _ops.streaming_sdf_stag_3d_multi
_native_bdim_coeff_3d = _ops.bdim_coeff_3d
bdim_coeff_sigma_3d = _ops.bdim_coeff_sigma_3d  # default; → Warp shim in the try
...
bdim_coeff_sigma_2d = _ops.bdim_coeff_sigma_2d  # default; → Warp shim in the try
...
try:
    ...
    # ── Kernel A (3-D) bridge ────────────────────────────────────────────────
    from lilytorch.warp_poc.warp_kernels import WarpStreamingSDF as _WarpSDF3D
    from lilytorch.warp_poc.warp_bdim import bdim_coeff_3d_warp as _bdim3d_warp
    ...
    streaming_sdf_stag_3d_multi = _native_streaming_sdf_3d
    bdim_coeff_3d = _native_bdim_coeff_3d
...
try:
    from lilytorch.warp_poc.warp_misc_2d import (
        apply_bcs_2d_warp as apply_bcs_2d,
        interp_2d_warp as interp_2d,
        ApplyBcs2DGraphRunner,
    )
    from lilytorch.warp_poc.warp_misc_3d import (
    ...
    ApplyBcs2DGraphRunner = None
    ApplyBcs3DGraphRunner = None
...
try:
    from lilytorch.warp_poc.warp_forces import (
...
K = _ops
try:
    from lilytorch.warp_poc import warp_poisson_2d as _wp2d  # noqa: F401
    from lilytorch.warp_poc import warp_poisson as _wp3d  # noqa: F401
    _warp_backed |= {
