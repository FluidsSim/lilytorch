...
Steps:
  1. Draw crop rectangle on video1.
  2. Scrub video1 to choose end time (applied to both).
  3. Draw crop rectangle on video2.
  4. Encode cropped + trimmed versions of both videos.
...
cx, cy, cw, ch = pick_crop(frame1, "Crop video1")
end_time = pick_end_frame(V1, "End-time video1 (applied to both)")

# ── Video 2 – pick crop independently ────────────────────────────────────────
frame2 = get_first_frame(V2)
h2, w2 = frame2.shape[:2]
c2x, c2y, c2w, c2h = pick_crop(frame2, "Crop video2")
