...
# The Eulerian streaming force readout — the n·δ viscous+pressure band integral
# plus the deltaH ∂H pressure pass — is a native CUDA / C++ op with an
# ``at::parallel_for`` CPU twin (see ops.cpp).  These are the in-module aliases
