...
# ═════════════════════════════════════════════════════════════════════════════
#  2-D VARIANT — multigrid transfer ops + WarpVCycle2D
#  Merged from the former multigrid_2d.py.  Reuses linear_weights/_wd/_f
#  (defined above) and adds the z-stripped `_2d` kernels/transfers.
# ═════════════════════════════════════════════════════════════════════════════
@wp.kernel
