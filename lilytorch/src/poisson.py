...
# ═════════════════════════════════════════════════════════════════════════════
#  2-D VARIANT — Poisson smoother/residual (WarpRBGS2D)
#  Merged from the former poisson_2d.py.  z-axis-stripped analogue of the
#  3-D kernels above; symbols suffixed `_2d`.  Shares _wdev/_wpf (defined
#  above).  dtype-generic f32+f64 via wp.overload.
# ═════════════════════════════════════════════════════════════════════════════
@wp.func
def _stencil_sum_2d(
