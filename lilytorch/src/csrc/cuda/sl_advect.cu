    ...
    scalar_t* __restrict__ out_w)
{
    ...
    scalar_t u1 = triquadratic_sample_off_3d(u, 0, Mx, My, Mz, u_bx0, u_by0, u_bz0, u_idx, u_idy, u_idz, X, Y, Z);
    scalar_t v1 = triquadratic_sample_off_3d(v, 0, Mx, My, Mz, v_bx0, v_by0, v_bz0, v_idx, v_idy, v_idz, X, Y, Z);
    scalar_t w1 = triquadratic_sample_off_3d(w, 0, Mx, My, Mz, w_bx0, w_by0, w_bz0, w_idx, w_idy, w_idz, X, Y, Z);
    scalar_t xm = X - half * dt * u1;
    scalar_t ym = Y - half * dt * v1;
    scalar_t zm = Z - half * dt * w1;

    scalar_t u2 = triquadratic_sample_off_3d(u, 0, Mx, My, Mz, u_bx0, u_by0, u_bz0, u_idx, u_idy, u_idz, xm, ym, zm);
    scalar_t v2 = triquadratic_sample_off_3d(v, 0, Mx, My, Mz, v_bx0, v_by0, v_bz0, v_idx, v_idy, v_idz, xm, ym, zm);
    scalar_t w2 = triquadratic_sample_off_3d(w, 0, Mx, My, Mz, w_bx0, w_by0, w_bz0, w_idx, w_idy, w_idz, xm, ym, zm);
    scalar_t xd = X - dt * u2;
    scalar_t yd = Y - dt * v2;
    scalar_t zd = Z - dt * w2;

    if (comp == 0) {
        out_u[lin] = triquadratic_sample_off_3d(u, 0, Mx, My, Mz, u_bx0, u_by0, u_bz0, u_idx, u_idy, u_idz, xd, yd, zd);
    } else if (comp == 1) {
        out_v[lin] = triquadratic_sample_off_3d(v, 0, Mx, My, Mz, v_bx0, v_by0, v_bz0, v_idx, v_idy, v_idz, xd, yd, zd);
    } else {
        out_w[lin] = triquadratic_sample_off_3d(w, 0, Mx, My, Mz, w_bx0, w_by0, w_bz0, w_idx, w_idy, w_idz, xd, yd, zd);
    }
}
