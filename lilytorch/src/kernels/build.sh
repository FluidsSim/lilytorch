...
rm -f build/temp.linux-*/lilytorch/src/csrc/cuda/streaming_sdf.o \
      build/temp.linux-*/lilytorch/src/csrc/cuda/streaming_sdf_2d.o \
      build/temp.linux-*/lilytorch/src/csrc/ops.o \
      build/temp.linux-*/lilytorch/src/csrc/streaming_sdf_cpu.o \
      build/temp.linux-*/lilytorch/src/csrc/streaming_sdf_cpu_2d.o 2>/dev/null || true
