...
export_directory = bpy.path.abspath("/data/andreaferrario/lilytorch/lilytorch/zebrafish/models/zebrafish_v1_triangulated_scale_x_80/sdf/meshes_zebrafish")  # Adjust the path as needed
...
for obj in selected_objects:
    if obj.type == 'MESH':  # Ensure only mesh objects are exported
        ...
        obj_name=split_name[0]+"_"+split_name[1]
        print(obj_name)

        obj_path = os.path.join(export_directory, f"{obj_name}.obj")
