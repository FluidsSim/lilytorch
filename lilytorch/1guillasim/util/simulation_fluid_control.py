...
from controllers.firing_rate_controller import FiringRateController
...
def run_experiment(pars):
    ...
    sim_options["n_iterations"]=animat_network.fluid_solver.nt
    sim_options["buffer_size"]=animat_network.fluid_solver.nt

    controller.pars.log_path = animat_network.fluid_solver.save_path
    controller.pars.n_iterations = animat_network.fluid_solver.nt
    controller.pars.buffer_size = animat_network.fluid_solver.nt
